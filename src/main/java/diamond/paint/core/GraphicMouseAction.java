...
public abstract class GraphicMouseAction
        implements GraphicMouseActionInterface {
     ...
     */
    @Override
    public void doAction(PaintContext context, Point2D.Double point,
    ...
    public Vector2d onMove(
            PaintContext context, AffineTransform affine,
            boolean differentAction) {
     ...
     */
    @Override
    public abstract void onRelease(PaintContext context, AffineTransform affine,
            boolean differentAction);
    ...
    protected void drawTemporaryLine(Graphics2D g2d, PaintContext context) {
        ...
        if (context.getVertexCount() > 0) {
            ...
            Color color = ElementSelector
                    .selectColorByLineType(PaintConfig.inputLineType);
            g2d.setColor(color);
            drawLine(g2d, picked,
                    GeometricOperation.getCandidateVertex(context, true));
        }
    ...
    protected void drawVertex(Graphics2D g2d, PaintContext context,
        ...
        g2d.fill(new Rectangle2D.Double(x - rectangleSize / 2 / scale,
                y - rectangleSize / 2 / scale, rectangleSize / scale,
                rectangleSize / scale));
