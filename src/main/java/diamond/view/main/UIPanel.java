...
//			if (document.buildOrigami3(origamiModel, false)) {
			...
			if (origamiModel.isProbablyFoldable()) {
				...
				if (JOptionPane.showConfirmDialog(
						DIAMOND.mainFrame, resources.getString(ResourceKey.WARNING, StringID.Warning.FOLD_FAILED_DUPLICATION_ID), 
					...
					if (origamiModel.isProbablyFoldable()) {
						...
						JOptionPane.showMessageDialog(
								DIAMOND.mainFrame, resources.getString(ResourceKey.WARNING, StringID.Warning.FOLD_FAILED_WRONG_STRUCTURE_ID), 
