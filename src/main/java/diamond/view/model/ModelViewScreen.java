...
implements MouseListener, MouseMotionListener, MouseWheelListener, ActionListener, ComponentListener {
    ...
    public void drawModel(Graphics2D g2d) {
        ...
        if (PaintConfig.bDispCrossLine) {
            ...
            g2d.draw(new Line2D.Double(crossLine.p0.x, crossLine.p0.y,
                    crossLine.p1.x, crossLine.p1.y));
        }
    }
    ...
    public void recalcCrossLine() {
        ...
        crossLine.p0.set(modelCenter.x - dir.x * 300,
                modelCenter.y - dir.y * 300);
        crossLine.p1.set(modelCenter.x + dir.x * 300,
                modelCenter.y + dir.y * 300);
