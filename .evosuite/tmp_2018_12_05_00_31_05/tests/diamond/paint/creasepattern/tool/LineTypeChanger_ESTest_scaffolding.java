...
public class LineTypeChanger_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "diamond.paint.creasepattern.tool.LineTypeChanger"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LineTypeChanger_ESTest_scaffolding.class.getClassLoader() ,
      "diamond.geom.Segment",
      "diamond.geom.Ray",
      "diamond.fold.OriHalfedge",
      "diamond.paint.creasepattern.tool.TypeForChange",
      "diamond.geom.Line",
      "diamond.paint.creasepattern.tool.ElementRemover",
      "diamond.geom.GeomUtil",
      "diamond.fold.OriFace",
      "diamond.value.OriPoint",
      "diamond.value.OriLine$Type",
      "diamond.paint.creasepattern.tool.LineTypeChanger",
      "diamond.value.OriLine"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LineTypeChanger_ESTest_scaffolding.class.getClassLoader()); 
