...
public class RectangleClipper_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "diamond.geom.RectangleClipper"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RectangleClipper_ESTest_scaffolding.class.getClassLoader() ,
      "diamond.geom.Segment",
      "diamond.geom.Line",
      "diamond.value.OriPoint",
      "diamond.value.OriLine$Type",
      "diamond.value.OriLine",
      "diamond.geom.RectangleClipper"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RectangleClipper_ESTest_scaffolding.class.getClassLoader()); 
